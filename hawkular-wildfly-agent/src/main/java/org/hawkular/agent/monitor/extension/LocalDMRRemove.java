...
public class LocalDMRRemove extends MonitorServiceRemoveStepHandler {

    public static final LocalDMRRemove INSTANCE = new LocalDMRRemove();

    private LocalDMRRemove() {
    }
