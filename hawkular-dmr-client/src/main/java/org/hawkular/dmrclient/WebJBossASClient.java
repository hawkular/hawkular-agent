...
public class WebJBossASClient extends JBossASClient {
    ...
    /**
     * The enable-welcome-root setting controls whether or not to deploy JBoss'
     * welcome-content application at root context. If you want to deploy your
     * own app at the root context, you need to disable the enable-welcome-root setting
     * on the default host virtual server. If you want to show the JBoss' welcome screen,
