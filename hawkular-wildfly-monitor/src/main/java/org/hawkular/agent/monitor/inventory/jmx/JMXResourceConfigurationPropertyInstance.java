...
public class JMXResourceConfigurationPropertyInstance extends
        ResourceConfigurationPropertyInstance<JMXResourceConfigurationPropertyType> {

    public JMXResourceConfigurationPropertyInstance(ID id, Name name,
