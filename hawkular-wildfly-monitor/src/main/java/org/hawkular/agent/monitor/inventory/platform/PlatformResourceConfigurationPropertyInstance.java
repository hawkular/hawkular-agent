...
public class PlatformResourceConfigurationPropertyInstance extends
        ResourceConfigurationPropertyInstance<PlatformResourceConfigurationPropertyType> {

    public PlatformResourceConfigurationPropertyInstance(ID id, Name name,
