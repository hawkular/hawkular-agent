...
public class PlatformMetricInstance extends
        MetricInstance<PlatformResource, PlatformMetricType, PlatformPropertyReference> {

    public PlatformMetricInstance(ID id, Name name, PlatformResource resource, PlatformMetricType metricType,
