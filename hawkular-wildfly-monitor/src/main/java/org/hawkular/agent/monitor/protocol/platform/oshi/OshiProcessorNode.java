 ...
 */
public class OshiProcessorNode extends OshiPlatformResourceNode<Processor> {

    public OshiProcessorNode(Processor delegate) {
        super(delegate);
    }
    ...
    public Object getAttribute(String attributeName) {
        switch (PlatformResourceAttributeName.ProcessorAttribute.valueOfOrFail(attributeName)) {
            case name:
            case processorNumber:
                return delegate.getProcessorNumber();
            case load:
                return delegate.getSystemCpuLoad();
        }
    ...
    public Set<String> getAttributeNames() {
        return PlatformResourceAttributeName.ProcessorAttribute.stringSet();
    }
