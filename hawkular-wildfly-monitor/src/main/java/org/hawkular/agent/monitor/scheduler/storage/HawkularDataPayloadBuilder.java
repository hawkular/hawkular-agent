 ...
 */
public class HawkularDataPayloadBuilder implements MetricDataPayloadBuilder {

    private HawkularMetricDataPayloadBuilder metricsPayloadBuilder = new HawkularMetricDataPayloadBuilder();
    ...
    public HawkularMetricDataPayloadBuilder toHawkularMetricsDataPayloadBuilder() {
