...
/**
 * Execute an operation on a DMR resource.
 */
public class ExecuteDMROperationCommand extends
        AbstractDMRResourcePathCommand<ExecuteOperationRequest, ExecuteOperationResponse> {
