...
public class StorageReporter extends ScheduledReporter {
    ...
    public static Builder forRegistry(MetricRegistry registry,
            AgentCoreEngineConfiguration.DiagnosticsConfiguration diagnosticsConfig, StorageAdapter storageAdapter) {
    ...
    public static class Builder {
        ...
        private Builder(MetricRegistry registry,
                AgentCoreEngineConfiguration.DiagnosticsConfiguration diagnosticsConfig,
                StorageAdapter storageAdapter) {
